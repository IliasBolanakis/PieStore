package com.ilbolan.piesstore.email;
...
import com.ilbolan.piesstore.models.PieDAO;
...
public class Email implements Serializable {
    ...
    // declare logger
    private static final AppLogger logger = new AppLogger(Email.class);
     ...
     * @param contactForm encapsulates all the recipient's data
     */
     ...
     * @param orderForm encapsulates all the recipient details
     */
