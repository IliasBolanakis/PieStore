 ...
 */
public class EmailValidator implements ConstraintValidator<EmailConstrains, String>, Serializable {

    private static final AppLogger logger = new AppLogger(EmailValidator.class);
